...
public class JourneyPair {
	...
	private Journey initiatorJourney;
	private Journey recieverJourney;
	...
	@DynamoDBIgnore
	public Journey getInitiatorJourney() {
		return initiatorJourney;
	}

	public void setInitiatorJourney(Journey initiatorJourney) {
		this.initiatorJourney = initiatorJourney;
	}

	@DynamoDBIgnore
	public Journey getRecieverJourney() {
		return recieverJourney;
	}
