		...
		<div class="row">
			<div class="col-md-7 text-left">
				...
				<div class="intro-section intro-section-from">
					<!-- WELCOM MESSAGE -->
			        <h1 class="intro white-text">Signup to Save Environment and Money</h1>
					<p class="transparent-text">Every time you share your car, you are not only helping environment and reducing traffic but also saving money. This is helping in reducing air and noise pollution as well as lowering the need of Oil. If you are already member of <strong>OddlyEven</strong> community, click on login.</p>
					<!-- BUTTON -->
