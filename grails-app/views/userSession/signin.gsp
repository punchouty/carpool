		...
		<div class="row">
			<div class="col-md-7 text-left">
				...
				<div class="intro-section intro-section-from">
					...
					<p class="transparent-text">Make new friends and transform a dull ride into an unforgettable journey. Better way to get Social. If you are not member of <strong>OddlyEven</strong> community, click below to Sign Up.</p>
					<!-- BUTTON -->
			...
			<div class="col-md-5 pull-right">
		        ...
		        <g:form action="login"  controller="userSession" name="login-form" method="post" class="registration-form" id="login-form">
