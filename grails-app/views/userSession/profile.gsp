			...
			<fieldset>
	          <legend>Update Profile</legend>
				...
				<div class="form-group">
					...
					<div class="controls">
						<input type="text" size="30" id="fullName" class="form-control" name="fullName" value="${user.profile?.fullName?.encodeAsHTML()}" placeholder="Full Name" maxlength="100" minlength="3" required> 
