...
<meta name="description" content="Terms and Conditions for using OddlyEven services">
	...
	<section class="white-bg-border" id="faq">
       <div class="container">
           ...
           <div class="section-header">
               ...
               <div class="sub-heading">
               		<strong>
                   Please read these Terms of Use carefully before using this Website and/or App. Your accessing or use of this Website and/or App and/or completing the registration, as well as your agreements to participate in rides set up through OddlyEven, or by email or telephone confirms your unconditional acceptance of the following Terms of Use. If you do not accept each and every of these Terms of Use, do not use this Website.
               		</strong>
               </div>
           </div>
           ...
           <div class="col-md-12 text-left">
               ...
               <div>
				These General Conditions Of Use apply to all services provider by Ezzie Infosystems, a company registered in India. Ezzie Infosystems own www.oddlyeven.in and related mobile applications at various smartphone stores.
				</div>
				...
				<div>
					<p>
						 There is no money transactions involved between the User and OddlyEven as actual ride will be provide by third party (Autos, Radio Taxi etc.). The third party needs to be paid directly by the Users availing their services.
					</p>
				</div>
				...
				<div>
					<p>
						By registering via our Website or our App, you agree and acknowledge that you may be subject to reviews and ratings by other Users. You agree and acknowledge that OddlyEven does not edit or curate such reviews and ratings, does not take effort to ensure their accuracy, and is not responsible for their content.
					</p>
				</div>
           </div>
       </div>
