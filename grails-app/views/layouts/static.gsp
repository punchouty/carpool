			...
			<ul class="nav nav-pills pull-right">
				<n:isNotLoggedIn>
					...
					<li <g:if test="${isSignup == 'true'}">class="active"</g:if>><g:link
							controller="staticPage" action="signup">Sign Up</g:link></li>
				</n:isNotLoggedIn>
				<n:isLoggedIn>
	...
	<nav class="container-narrow" role="navigation">
        <div class="site-footer">
            ...
            <ul class="site-footer-links right">       
            	<li<g:if test="${isTerms == 'true'}">class="active"</g:if>><g:link controller="staticPage" action="terms">Terms</g:link></li>
            	<li<g:if test="${isPrivacy == 'true'}">class="active"</g:if>><g:link controller="staticPage" action="privacy">Privacy</g:link></li>	
            </ul>
        </div>
   	</nav>
