...
<div id="timeline">
			...
			<div class="timeline-item">
				<div class="timeline-icon">
					<img src="${grailsApplication.config.grails.serverURL}/images/icons/home.svg" alt="">
				</div>
			...
			<div class="timeline-item">
				<div class="timeline-icon">
					<img src="${grailsApplication.config.grails.serverURL}/images/icons/marker.svg" alt="">
				</div>
			...
			<g:elseif test ="${wayPoints?.size()==4}">
	            ...
	            <div class="timeline-item">
					<div class="timeline-icon">
						<img src="${grailsApplication.config.grails.serverURL}/images/icons/star.svg" alt="">
					</div>
					<div class="timeline-content right">
