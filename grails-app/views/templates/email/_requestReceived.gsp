...
<table cellspacing="0" border="0" bgcolor="#ffffff" style="margin: 0; padding: 0; border: 0;" width="100%" cellpadding="0">
  <tr style="margin: 0; padding: 0; border: 0;">
	...
	<tr>
		...
		<h1 style="font-size: 20px; font-weight: bold; border: 0; color: #767676; display: inline; padding: 0; margin-top: 0px; margin-bottom: 0px; font-family:Helvetica, Arial, sans-serif">You have received a new OddlyEven request</h1>
		</td>
	</tr>
	</table>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<p style="margin-bottom: 15px; margin-top: 0; padding: 0; font-size: 12px; font-family: Helvetica, Arial, sans-serif; color:#949494">Your have received a new OddlyEven share request for ${journeyDate} to ${destination} from ${sender}.</p>

<p style="margin-bottom: 15px; margin-top: 0; padding: 0; font-size: 12px; font-family: Helvetica, Arial, sans-serif; color:#949494">Please log on to the OddlyEven app to Accept or Reject the request.</p>
