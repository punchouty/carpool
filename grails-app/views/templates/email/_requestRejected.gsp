...
<table cellspacing="0" border="0" bgcolor="#ffffff" style="margin: 0; padding: 0; border: 0;" width="100%" cellpadding="0">
  <tr style="margin: 0; padding: 0; border: 0;">
	...
	<tr>
		...
		<h1 style="font-size: 20px; font-weight: bold; border: 0; color: #767676; display: inline; padding: 0; margin-top: 0px; margin-bottom: 0px; font-family:Helvetica, Arial, sans-serif">Your CabShare request has been rejected</h1>
		</td>
	</tr>
	</table>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<p style="margin-bottom: 15px; margin-top: 0; padding: 0; font-size: 12px; font-family: Helvetica, Arial, sans-serif; color:#949494">Your cab share request for ${journeyDate} to ${destination} has been rejected by ${rejecter}.</p>

<p style="margin-bottom: 15px; margin-top: 0; padding: 0; font-size: 12px; font-family: Helvetica, Arial, sans-serif; color:#949494">But don't worry. Log on to the CabShare app again and keep on looking for new sharing partners.</p>
