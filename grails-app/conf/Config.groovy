...
grails.email.mail.from="info@oddlyeven.in"
...
grails.messaging.mail.from="info@oddlyeven.in"
...
environments {
	...
	production {
		grails.serverURL="http://www.oddlyeven.in"
		grails.startup.elasticsearch.index.create = false
		grails.startup.sampleUsers.create = false
		grails.startup.masterData.places.create = false
		...
		grails.plugin.facebooksdk.app.id = 1049343688459536
		grails.plugin.facebooksdk.app.permissions = ['email']
...
grails {
	mail {
		from = "OddlyEven <info@oddlyeven.in>"
